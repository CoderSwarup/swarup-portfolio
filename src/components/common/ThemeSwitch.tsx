...
/**
 * @description Hook to toggle the theme of the application.
 * @param variant - The variant of the theme toggle animation.
 * @param start - The start position of the theme toggle animation.
 * @param blur - Whether to apply blur effect to the theme toggle animation.
 * @param gifUrl - Optional URL of the GIF to be used for the theme toggle animation.
 * @returns The theme toggle hook.
 */
...
/**
 * @description ThemeToggleButton component is used to toggle the theme of the application.
 * @param className - Optional className to be added to the button.
 * @param variant - Optional variant of the theme toggle animation.
 * @param start - Optional start position of the theme toggle animation.
 * @param blur - Optional blur effect for the theme toggle animation.
 * @param gifUrl - Optional URL of the GIF to be used for the theme toggle animation.
...
/**
 * @description Animation variant for the theme toggle animation.
 */
...
/**
 * @description Get position coordinates for the theme toggle animation.
 * @param position - The position of the theme toggle animation.
 * @returns The position coordinates for the theme toggle animation.
 */
...
/**
 * @description Generate SVG for the theme toggle animation.
 * @param variant - The variant of the theme toggle animation.
 * @param start - The start position of the theme toggle animation.
 * @returns The SVG for the theme toggle animation.
 */
...
/**
 * @description Get transform origin for the theme toggle animation.
 * @param start - The start position of the theme toggle animation.
 * @returns The transform origin for the theme toggle animation.
 */
...
/**
 * @description Create animation for the theme toggle animation.
 * @param variant - The variant of the theme toggle animation.
 * @param start - The start position of the theme toggle animation.
 * @param blur - Whether to apply blur effect to the theme toggle animation.
 * @param url - Optional URL of the GIF to be used for the theme toggle animation.
 * @returns The animation for the theme toggle animation.
 */
